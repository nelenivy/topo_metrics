...
# Fast local_cov_spectrum k sweep without RankMe. This skips eigvalsh and
# spectral entropy columns, using trace powers for NESum, participation ratio,
# and low-order invariants.
...
LOCAL_COV_TRANSFORMS="${LOCAL_COV_TRANSFORMS:-ne_sum participation_ratio invariants}"
...
echo "Running fast local_cov_spectrum k sweep without RankMe"
