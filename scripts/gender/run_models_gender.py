...
class ModelKeeper:
    ...
    def curr_checkpoint_name(self):
        return f"model_{self.hyperparams['batch_size']}_{self.hyperparams['learning_rate']}" \
            ...
            f"_{self.hyperparams['category_embedding_dim']}_{self.hyperparams['hidden_size']}" \
            f"_{self.hyperparams['loss']}_{self.hyperparams['rnn_encoder_type']}"
    ...
    def train_model(self, hyperparams, checkpoints_path, recalculate=False, devices=0):
        ...
        trx_encoder_params = dict(
            ...
            embeddings={
                "mcc_code": {
                    "in": hyperparams['mcc_code_in'],
                    "out": hyperparams['category_embedding_dim']
                },
                "term_id": {
                    "in": hyperparams['term_id_in'],
                    "out": hyperparams['category_embedding_dim']
                },
                "tr_type": {
                    "in": hyperparams['tr_type_in'],
                    "out": hyperparams['category_embedding_dim']
                },
            },
    ...
    def calc_embs_from_trained(self, test_data):
        ...
        for i, checkpoint in enumerate(checkpoint_files):
            ...
            print("len of inf_test_embeddings:", len(inf_test_embeddings))
