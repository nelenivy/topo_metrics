...
- **financial_analytics/gender/gender_script_device_0.py and gender_script_device_1.py**
 Python scripts for hyperparameter optimization and optimal epoch selection experiments on the age and gender prediction datasets in the financial analytics context, designed for execution on specific devices.
